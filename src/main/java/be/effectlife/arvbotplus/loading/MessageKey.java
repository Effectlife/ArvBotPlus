...
public enum MessageKey {
    ...
    SCENE_POLLS_TEXT_MULTI("scene.polls.text.multi"),
    ...
    TWIRK_PATTERN_COMMAND_ROLL("twirk.pattern.command.roll"),
    TWIRK_PATTERN_COMMAND_NOMINATE("twirk.pattern.command.nominate"),
    TWIRK_PATTERN_COMMAND_NOMINATE_SHORT("twirk.pattern.command.nominateshort"),
    ...
    TWIRK_MESSAGE_MULTIVOTE_ALREADY_CAST("twirk.message.multivote.already.cast"),
    TWIRK_MESSAGE_MULTIVOTE_ALREADYVOTED("twirk.message.multivote.alreadyvoted"),
    ...
    TWIRK_MESSAGE_CHANGEVOTE_IMPROPER("twirk.message.changevote.improper"),
    TWIRK_MESSAGE_CHANGEVOTE_NOTYETVOTED("twirk.message.changevote.notyetvoted"),
    TWIRK_MESSAGE_CHANGEVOTE_NOTYETVOTED_MULTIVOTE("twirk.message.changevote.notyetvoted.multivote"),
    ...
    TWIRK_MESSAGE_NOMINATION_HELP("twirk.message.nomination.help"),
    TWIRK_MESSAGE_NOMINATION_NOVALUE("twirk.message.nomination.novalue"),
    TWIRK_MESSAGE_NOMINATION_SUCCESS("twirk.message.nomination.success"),
    TWIRK_MESSAGE_NOMINATION_PRESENT("twirk.message.nomination.present"),
    TWIRK_MESSAGE_NOMINATION_DISABLED("twirk.message.nomination.disabled"),
    TWIRK_MESSAGE_NOMINATION_NOTENOUGHOPTIONS("twirk.message.nomination.notenoughoptions"),
    TWIRK_MESSAGE_DO_ROLL("twirk.message.do.roll"),
    TWIRK_MESSAGE_ROLL_FAILED("twirk.message.roll.failed"),
    ...
    TWIRK_MESSAGE_ROLL_HELP("twirk.message.roll.help"),
