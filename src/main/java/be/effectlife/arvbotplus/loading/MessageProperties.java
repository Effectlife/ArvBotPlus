...
public class MessageProperties {
    public final static String REPLACEHOLDER_OPEN = "" + (char) 30; //uses ascii Record separator
    public final static String REPLACEHOLDER_CLOSE = "" + (char) 31;//uses ascii Unit separator
    ...
    private static Properties loadProperties() throws IOException {
        ...
        try {
            ...
            LOG.error("Cannot find properties file " + propFileName + "; Generating default file and exiting program.");
            try {
    ...
    public static String generateString(MessageKey key, Map<String, String> replacements) {
        ...
        replacements.put("connectedchannel", Main.twirkSystem.getConnectedChannel());
