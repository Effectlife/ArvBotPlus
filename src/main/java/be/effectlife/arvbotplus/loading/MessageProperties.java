...
public class MessageProperties {
    private static final String DEFAULT_STRINGS = "#When editing this file, the app has to be restarted to see the changes. It gets loaded in at boot.\n" +
    ...
    static {
        try {
            properties = BasicUtilities.loadProperties("./strings.properties", DEFAULT_STRINGS);
        } catch (IOException e) {
